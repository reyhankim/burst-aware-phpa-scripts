...
public class FlightServiceTests {
  ...
  private static final String QUERY_ENDPOINT="/queryflights";
  private static final String QUERY_RESPONSE="\"originPort\":\"CDG\",\"destPort\":\"LHR\",\"miles\":209";

  private static final String REWARD_ENDPOINT="/getrewardmiles";
  private static final String REWARD_RESPONSE="{\"miles\":209}";
  ...
  public static void oneTimeSetup() throws UnknownHostException, IOException {
    ...
    BASE_URL_WITH_CONTEXT_ROOT = BASE_URL + "/flight";
...
Version.Main.PRODUCTION.getFeatures());
  ...
  @Test
  public void test5_GetFlight() throws InterruptedException {
    ...
    assertThat(result, containsString(QUERY_RESPONSE));
  ...
  @Test   
  public void test6_Reward() throws InterruptedException {
    String url = BASE_URL_WITH_CONTEXT_ROOT + REWARD_ENDPOINT; 
    WebTarget target = client.target(url);
     
    Form form = new Form();
    form.param("flightSegment", "AA278");
    ...
    String result = response.readEntity(String.class);
    assertThat(result, containsString(REWARD_RESPONSE));
